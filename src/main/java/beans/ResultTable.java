...
import beans.mbeans.HitPercentage;
import beans.mbeans.HitPercentageMBean;
import beans.mbeans.PointCounter;
import beans.mbeans.PointCounterMBean;
...
public class ResultTable implements Serializable {
    ...
    public void init() {
        try {
            ...
            try {
                ...
                ObjectName pointCounterName = new ObjectName("beans.mbeans:type=PointCounter");
                pointCounter = new PointCounter(this);
                ...
                hitPercentage = new HitPercentage(pointCounter);
                ObjectName hitPercentageName = new ObjectName("beans.mbeans:type=HitPercentage");
    ...
    public void addPoint(Point row) {
        try {
            ...
            if (row.isInArea()) {
                pointCounter.resetConsecutiveMisses();
            } else {
    ...
    public void clear() {
        try {
            ...
            pointCounter.resetAndInitializeCounts();
